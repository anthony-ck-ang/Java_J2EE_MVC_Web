...
import com.anthonyang.livre.dao.BookmarkDao;
import com.anthonyang.livre.entities.Book;
import com.anthonyang.livre.entities.Bookmark;
import com.anthonyang.livre.entities.Movie;
import com.anthonyang.livre.entities.User;
import com.anthonyang.livre.entities.UserBookmark;
import com.anthonyang.livre.entities.WebLink;
import com.anthonyang.livre.util.HttpConnect;
...
public class BookmarkManager {
	...
	public void saveUserBookmark(User user, Bookmark bookmark) {
		...
		//download only if bookmark is a webLink and is not pdf format
	...
	public void share(User user, Bookmark bookmark) {
		...
		if (bookmark instanceof Book) {
			// can sent this information to external parties using different integration
			// technologies
