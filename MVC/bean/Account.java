...
public class Account {
	...
	Date ws_last_date;
	public Account(int ws_cust_id, int ws_acct_id, String ws_acct_type,
			double ws_acct_balance, Date ws_acct_crdate,
	...
	public String toString() {
		return "Account [ws_cust_id=" + ws_cust_id + ", ws_acct_id="
				+ ws_acct_id + ", ws_acct_type=" + ws_acct_type
				+ ", ws_acct_balance=" + ws_acct_balance + ", ws_acct_crdate="
				+ ws_acct_crdate + ", ws_acct_lasttrdate=" + ws_acct_lasttrdate
				+ ", ws_acct_duration=" + ws_acct_duration + ", ws_last_date="
				+ ws_last_date + "]";
	}
