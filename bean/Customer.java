...
public class Customer {
	...
	public Customer(int ws_ssn, int ws_cust_id, String ws_name, String ws_adrs, int ws_age, Date ws_last_date) {
		super();
		this.ws_ssn = ws_ssn;
	...
	public String toString() {
		return "Customer [ws_ssn=" + ws_ssn + ", ws_cust_id=" + ws_cust_id + ", ws_name=" + ws_name + ", ws_adrs="
				+ ws_adrs + ", ws_age=" + ws_age + ", ws_last_date=" + ws_last_date + "]";
	}
