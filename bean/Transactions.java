...
public class Transactions {
	...
	public Transactions(int ws_cust_id, String ws_acct_type, double ws_amt, Date ws_trxn_date, String ws_src_typ) {
		super();
	...
	public String toString() {
		return "Transactions [ws_cust_id=" + ws_cust_id + ", ws_acct_type=" + ws_acct_type + ", ws_amt=" + ws_amt
				+ ", ws_trxn_date=" + ws_trxn_date + ", ws_src_typ=" + ws_src_typ + "]";
	}
