...
<h2><font color="white"> Please press List to list all accounts in the system</h2>
...
<tr>
	...
	<br>
	<button type="submit" class="btn btn-warning" name="ListAccounts" value="List">List Accounts</button>
	<br>
	<br>
