...
<table border="0px" width="30%" align="center">

	<center><td colspan ="2" bgcolor ="" align="left"><h1><b><font color="white">Select Account </b></h1></font></td></center>
	<tr><td bgcolor =""><font color="white">Customer ID:</font></td><td bgcolor =""> <font color="white"> <%= session.getAttribute("custid") %></font></td></tr>
					
					
					<tr><td bgcolor =""><font color="white">Accounts</font></td>
					<td bgcolor ="">
					
					<select name ="Accounts" style ="width:180px" >
					
					
				
	<%
		ArrayList<Account> aList2 = (ArrayList<Account>)request.getAttribute("acclist");
		if(aList2!=null)
		{
			...
			{
		%>
  			<option value=<%=a.getWs_acct_id() %>><%= a.getWs_acct_type()%>   |    <%= a.getWs_acct_id()%></option>
	...
	<button type="Submit" value="Submit" name="submitAccountId" class="btn btn-primary active">Submit</button> <button type="button" class="btn btn-primary active" onclick="history.go(-1);">Back</button>
</form>
<%
			}else {
		%>
