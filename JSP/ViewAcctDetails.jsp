...
<table border="0px" width="30%" align="center">
	...
	<tr><td colspan ="2" bgcolor =""><h1><font color="white">Account:<b> <%= session.getAttribute("acctid") %></b> </font></h1> </td></tr>
	<tr><td colspan ="2" bgcolor =""><font color="white">Customer ID: <b> <%= session.getAttribute("custid") %></b></font></td></tr>
	<tr><td colspan ="2" bgcolor =""><font color="white">Account Type: <b> <%= session.getAttribute("acctType") %></b></font></td></tr>
	<tr><td colspan ="2" bgcolor =""><font color="white">Account Balance:<b>  $ <%= session.getAttribute("acctBal") %></b></font></td></tr>
	

	</table><br>
	<center><input type ="button" value="Deposit" name="Deposit" class="btn btn-warning">
	<input type ="button" value="Transfer" name="Transfer" class="btn btn-warning">
	<input type ="button" value="Withdraw" name="Withdraw" class="btn btn-warning"></center>
