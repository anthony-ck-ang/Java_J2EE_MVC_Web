...
<div  class="table-responsive">
									 ...
									 <table class="table table-hover" border ='0' >
									 	 ...
									 	 <tr class="success" align = "center"><th align = "center"><b><center><font color = "white" face = "Arial">Select either SSN or ID to delete:</font></center></b></TH></tr>
										
	
			
										<tr bgcolor="#edeff2"><td align = "center"> <input type="radio" name="selection4"  checked="checked" value="SSN" ><p>Customer SSN</p>
										<input type="radio" name="selection4" value="ID"><p>Customer ID</p></td></tr>
		...
		<input type="text" id = "ssn" size = "20" maxlength="9"   pattern="(.){9,9}" name = "DeleteSelection1" required>
		<button type="Submit" class="btn btn-warning" onClick="return validate();" value = "Submit" name = "DeleteAccount1">Delete</button>
