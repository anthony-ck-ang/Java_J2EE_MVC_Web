                    ...
                    <div class="row">
                    	...
                    	<div class="panel panel-default">
   						 <table class="table table-bordered">
								...
								<tr><td colspan ="2" bgcolor ="#c3c3c3"><h1>Welcome!</h1></td></tr>
								<tr><td colspan ="2" bgcolor ="#c3c3c3">Customer name: <%= session.getAttribute("name") %></td></tr>
								<tr><td colspan ="2" bgcolor ="#c3c3c3">Customer add: <%= session.getAttribute("address") %></td></tr>
								<tr><td colspan ="2" bgcolor ="#c3c3c3">Customer age: <%= session.getAttribute("age") %></td></tr>
								<tr><td colspan ="2" bgcolor ="#c3c3c3">Customer custId: <%= session.getAttribute("custid") %></td></tr>
								<tr><td colspan ="2" bgcolor ="#c3c3c3">Customer ssn: <%= session.getAttribute("ssn") %></td></tr>
								...
								<div  class="table-responsive">
									 ...
									 <table class="table table-bordered table-hover" >
										 ...
										 <tr class="success"><td  align = "center"colspan = "2"><b>Customer Details</b> </td></tr>
									
									 	<tr bgcolor="#edeff2"><td class="danger" align = "center">Customer name:</td><td class="danger"><%= session.getAttribute("name") %></td></tr>
										<tr bgcolor="#edeff2"><td align = "center">Customer address:</td><td><%= session.getAttribute("address") %></td></tr>
										<tr bgcolor="#edeff2"><td align = "center">Customer age:</td><td><%= session.getAttribute("age") %></td></tr>
										<tr bgcolor="#edeff2"><td align = "center">Customer ID:</td><td><%= session.getAttribute("custid") %></td></tr>
									 	<tr bgcolor="#edeff2"><td align = "center">Customer SSN:</td><td><%= session.getAttribute("ssn") %></td></tr>
