...
<script language = "javascript">
  function validate(){
	...
	if(input =="" )
	{alert('Please enter input ');return false;}
...
<!-- Top menu -->
		<nav class="navbar navbar-inverse navbar-no-bg" role="navigation">
		 ...
		 <div>
       			<table align = "left">
					...
					<tr><td WIDTH="100"></td><td><font color = "white"><font color = "white" face = "Arial">Welcome <b><%=u.getUsername() %> (Cashier/Teller)!</font></td></tr>
					<tr><td></td></tr>
				</table>
	...
	<table align="center" width="50%" border="0">
			...
			<tr></tr>
				<tr>
				<td colspan="4" align="center" bgcolor=""><H2><font color="white">Account Search</font></H2></td>
			</tr>
			<tr></tr>
			...
			<td colspan="2" align="center" style="width:500px"><input type = "radio" name ="t1" value="SSN ID" checked="checked" ><font color="white"> SSN Id <input type = "radio" name ="t1" value="Customer Id"> Customer Id <input type = "radio" name ="t1" value="Account Id"> Account Id</font>
			</td>
			</tr>
			...
			<td bgcolor =""></td><td bgcolor =""><input type="text" name ="input" id="input" size ="30" maxlength="9">
		
			&nbsp;&nbsp;<button type="Submit" value="Submit" name="submitChoice" onClick="return validate();" class="btn btn-primary active">Submit</button>&nbsp;&nbsp;<button type="reset" value="Clear" name="clear" class="btn btn-primary active">Clear</button>
			</td>
