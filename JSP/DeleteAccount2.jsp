...
<center>
<div class="div1">Account Details</div>
<table border = "0">
<tr>
<th colspan="3">
...
<div  class="table-responsive">
									 ...
									 <table class="table table-hover" border ='1' >
									 	 ...
									 	 <tr class="success" align = "center"><th align = "center" colspan = '2'><center><font color = "white" face = "Arial">Please confirm details to list accounts:</font></center></TH></tr>
										...
										<tr bgcolor="#edeff2"><td align = "center"> Customer Name:</a></td><td> <%= customer1.getWs_name() %> </td></tr>
										<tr bgcolor="#edeff2"><td align = "center"> Customer Age:</a></td><td> <%=customer1.getWs_age() %> </td></tr>
										<tr bgcolor="#edeff2"><td align = "center"> Customer Address:</a></td><td> <%= customer1.getWs_adrs() %> </td></tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<tr>
				<td align="center"><input type="submit" class="btn btn-warning" name="ListDeleteAccount" value="List All Accounts of the Customer"></td>
