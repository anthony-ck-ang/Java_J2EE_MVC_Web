...
"> 
									 <table class="table table-hover" border ='1' >
									 	 ...
									 	 <tr class="success" align = "center"><th align = "center" colspan = '2'><b><center><font color = "white" face = "Arial">Customer Details</center></b></TH></tr>
										
	
										<tr bgcolor="#edeff2"><td align = "center"> Customer Name:</a></td><td> <%= session.getAttribute("name") %> </td></tr>
										<tr bgcolor="#edeff2"><td align = "center"> Customer Address:</a></td><td> <%= session.getAttribute("address")%> </td></tr>
										<tr bgcolor="#edeff2"><td align = "center"> Customer Age:</a></td><td> <%= session.getAttribute("age") %> </td></tr>
									<tr bgcolor="#edeff2"><td align = "center"> Customer ID:</a></td><td> <%=session.getAttribute("custid") %> </td></tr>
									<tr bgcolor="#edeff2"><td align = "center"> Customer SSN:</a></td><td> <%=session.getAttribute("ssn") %> </td></tr>
