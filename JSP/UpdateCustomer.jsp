...
<div  class="table-responsive">
									 ...
									 <table class="table table-hover" border ='0' >
									 	...
									 	<tr class="success" align = "center"><th><center><font color = "white" face = "Arial">Select either SSN or ID to search:</font></center></TH></tr>
										<tr bgcolor=""><td align = "center"> <input type="radio" name="selection3"  checked="checked" value="SSN" ><p>Customer SSN</p>
											<input type="radio" name="selection3" value="ID"><p>Customer ID</p></td></tr>
		...
		<input type="text" size = "20" id = "ssn"  maxlength="9" name = "UpdateSelection" required>

		<!--  <input type = "Submit" value = "Update" name = "Update1">-->
		<button type="Submit" class="btn btn-warning" value = "Update" onClick="return validate();" name = "Update1">Update</button>
		<br>
